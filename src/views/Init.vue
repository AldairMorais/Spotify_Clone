<template>
    <div class="w-screen bg-white flex justify-center">
        <div class="flex py-10 items-center flex-col w-4/12">
            <a href="" class="mb-10">
                <logoSpt_b />
            </a>
            <h3 class="font-bold tracking-tighter text-3xl">Inscreva-se grátis e comece a curtir.</h3>

            <div class="mt-8">
                <a href=""
                    class="bg-blue-800 mb-6 rounded-full py-3 gap-x-5 items-center px-20 hover:scale-105 text-center flex">
                    <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            ...
                            <image id="image0_213_540" width="130" height="130"
                    ...
                    <span class="text-white font-semibold text-sm tracking-wider"> Inscrever-se com o Facebook</span>

                </a>

                <a href=""
                    class="border-2 mb-6 border-black border-opacity-50 rounded-full py-3 gap-x-5 items-center px-20 hover:scale-105 text-center flex">
                    ...
                    <span class="text-black text-opacity-50 font-semibold text-sm tracking-wider"> Inscrever-se com o
                        Google</span>
            ...
            <div class="flex justify-center">
                <span
                    class="before:border-t before:table-cell before:relative before:top-3  before:w-96 after:border-t after:table-cell after:relative after:top-3  after:w-96 table relative w-96 h-10 border-gray-900">
                    <p class="bg-white px-5">ou</p>
                </span>
            </div>

            
                <h4 class="font-bold text-center tracking-wide ext-lg">Inscreva-se com seu endereço de e-mail</h4>
               <div class=" justify-center w-full">
                <Inputs label="Qual é o seu e-mail?" placeholder="Insira seu e-mail."/>
                <Inputs label="Confirme seu e-mail?" placeholder="Insira o e-mail novamente."/>
                <Inputs label="Crie uma senha" placeholder="Crie uma senha."/>
                <Inputs label="Como devemos chamar você?" placeholder="Insira um nome de perfil"/>
               </div>
...
import logoSpt_b from '../components/logo_b.vue';
