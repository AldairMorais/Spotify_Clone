<template>
    <div>
        <svg role="img" height="24" width="24" fill="currentColor" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon">
        ...
        <!-- <svg role="img" height="24" width="24" fill="currentColor" class="text-white" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon">
